...
class WeixinAction extends Action {
    ...
    private function receiveImage($object)
    {
       ...
       /* $wcHelper=new wechatHelper();
        ...
        $content = array();
        $content[] = array("Title"=>"图片上传成功",  "Description"=>"图片上传成功，接下来可以打印此图片", "PicUrl"=>  $object['PicUrl'], "Url" =>"http://p.webs.dlwebs.com/index.php/zoom/".urlencode($object['FromUserName'])."/?picurl=".$object['PicUrl']);
